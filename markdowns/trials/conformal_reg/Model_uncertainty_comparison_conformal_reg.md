...
# ── Directory layout ─────────────────────────────────────────
MODEL_DIR   = Path('/content/drive/My Drive/Classification/conformal_reg/models')
RESULTS_DIR = Path('/content/drive/My Drive/Classification/conformal_reg/results')
...
TRUSTED_MODEL_ROOTS = [
    Path('/content/drive/My Drive/Classification/conformal_reg/models'),
