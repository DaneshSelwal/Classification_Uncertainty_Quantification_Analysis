...
# ── Directory layout ─────────────────────────────────────────
MODEL_DIR   = Path('/content/drive/My Drive/Classification/cb_focal_loss/models')
RESULTS_DIR = Path('/content/drive/My Drive/Classification/cb_focal_loss/results')
...
TRUSTED_MODEL_ROOTS = [
    Path('/content/drive/My Drive/Classification/cb_focal_loss/models'),
