...
TRUSTED_MODEL_ROOTS = [
    Path('/content/drive/My Drive/Classification/spatialgcn/models'),
...
```text
SpatialGCN: /content/drive/My Drive/Classification/spatialgcn/models/SpatialGCN_best.keras
Workbook: /content/drive/My Drive/Classification/spatialgcn/results/uncertainty_results/conformal_reports_all_models.xlsx
```
...
class GraphConvLayer(layers.Layer):
    ...
    constant computed once at build time -- not a per-sample input. Must
    match Model_training.ipynb's definition exactly, since it is
    deserialised from the saved .keras model file (SpatialGCN).
    """
...
Securely loads the SpatialGCN model from a trusted path and runs a small forward pass to verify output shape and numerical sanity.
...
```text
Loading SpatialGCN from /content/drive/My Drive/Classification/spatialgcn/models/SpatialGCN_best.keras
  Loaded SpatialGCN successfully.
SpatialGCN smoke output: (8, 7)
```
...
==================== SpatialGCN ====================
Computing full-scene probabilities for SpatialGCN ...
...
SplitConformal: coverage=0.9522, avg_set=1.458, runtime=1.81s
ClassConditionalConformal: coverage=0.9587, avg_set=1.778, runtime=1.65s
RC3P: coverage=0.9606, avg_set=1.830, runtime=1.70s
ClusteredConformal: coverage=0.9555, avg_set=1.651, runtime=3.06s
RAPS: coverage=0.9531, avg_set=1.479, runtime=0.72s
```
...
```text
Saved workbook:      /content/drive/My Drive/Classification/spatialgcn/results/uncertainty_results/conformal_reports_all_models.xlsx
Saved summary CSV:   /content/drive/My Drive/Classification/spatialgcn/results/uncertainty_results/summary_metrics.csv
Saved per-class CSV: /content/drive/My Drive/Classification/spatialgcn/results/uncertainty_results/per_class_coverage.csv
Saved run config:    /content/drive/My Drive/Classification/spatialgcn/results/uncertainty_results/run_config.json
```
...
required_prefixes = {
    ...
    'Split_SpatialGCN',
    'ClassCond_SpatialGCN',
    'RC3P_SpatialGCN',
    'Clustered_SpatialGCN',
    'RAPS_SpatialGCN',
...
```text
   model_name                     method  target_coverage  empirical_coverage  \
0  SpatialGCN  ClassConditionalConformal             0.95            0.958701   
1  SpatialGCN         ClusteredConformal             0.95            0.955452   
2  SpatialGCN                       RAPS             0.95            0.953132   
3  SpatialGCN                       RC3P             0.95            0.960557   
4  SpatialGCN             SplitConformal             0.95            0.952204   

   avg_set_size  median_set_size  singleton_rate  empty_set_rate  runtime_sec  \
0      1.777726              1.0        0.510905             0.0     1.647652   
1      1.650580              1.0        0.543852             0.0     3.064467   
2      1.478886              1.0        0.611601             0.0     0.721734   
3      1.829698              2.0        0.474246             0.0     1.700016   
4      1.458469              1.0        0.619026             0.0     1.814477   

   alpha   lam  n_clusters  mean_per_class_coverage  
0   0.05   NaN         NaN                 0.951011  
1   0.05   NaN         4.0                 0.926541  
2   0.05  0.01         NaN                 0.905470  
3   0.05   NaN         NaN                 0.953019  
4   0.05   NaN         NaN                 0.904930  
```
